...
int main(int argc, char const *argv[]) {
  ...
  Mat frame, preview; // create image matrix.
  ...
  ROIRight.width *= frameScale;
  ROIRight.height *= frameScale;
...
//  }
  ...
  outputFile << "time,left,leftH,leftW,right,rightH,rightW\n";
  float currentPos;
  ...
  while(webcam.isOpened()){
    ...
    result_left = frameAnalysis_line(&leftFrame, &outputFile, ',');
    result_right = frameAnalysis_line(&rightFrame, &outputFile, '\n');

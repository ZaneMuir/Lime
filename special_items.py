...
#import numpy as np
#========================常量设置========================
target_data_path = os.path.join(os.path.split(__file__)[0],'data/20171007_002.txt') #NOTE: 处理的目标原始文件
eye_data_path = os.path.splitext(target_data_path)[0]+'_%d_eye_10min.csv'
